...
<template>
  ...
  <div v-if="userStore.currentUser.role === 'employee'" class="body">
    <div class="card-style2 relative">
      <div class="mx-auto my-8 flex justify-center">
        <div class="grid grid-cols-3 gap-4">
          ...
          <div class="overflow-hidden rounded-lg">
            <img
              src="https://i.pinimg.com/736x/33/be/e6/33bee69ae44b127476db0ee55c741f57.jpg"
              alt="Check-Out Management"
              class="image-menu"
            />
          ...
          <div class="overflow-hidden rounded-lg">
            <img
              src="https://i.pinimg.com/564x/66/05/bd/6605bdf5bfc8f0c2b3a9436d2754cb8e.jpg"
          ...
          <div class="overflow-hidden rounded-lg">
            <img
              src="https://i.pinimg.com/564x/18/11/3f/18113f1ba1f4f8e18bc5d721b440c237.jpg"
          ...
          <div class="overflow-hidden rounded-lg">
            <img
              src="https://i.pinimg.com/564x/98/41/0c/98410c9514982cd16615d8ffa1b0f150.jpg"
   ...
   <div
    v-else
    class="body overflow-y-auto dc-scroll"
  >
