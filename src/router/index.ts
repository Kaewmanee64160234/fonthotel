...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "about" */ "../views/SelectGuestDateView.vue"
      ),
    meta: { hideNavigation: false },
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "about" */ "../views/AuthenticationView/LoginView.vue"
      ),
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "about" */ "../views/AuthenticationView/RegisterView.vue"
      ),
    meta: { hideNavigation: true },
  },

  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "about" */ "../components/RoomDetailCard.vue"
      ),
    meta: { hideNavigation: true },
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "about" */ "../views/Employee/AcceptBookingView.vue"
      ),
    meta: { hideNavigation: false },
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "selectroom" */ "../views/SelectRoomView.vue"
      ),
    meta: { hideNavigation: false },
  },
  ...
  },
  {
    ...
    // which is lazy-loaded when the route is visited.
    component: () =>
      import(/* webpackChunkName: "about" */ "../views/ReadMoreView.vue"),
    meta: { hideNavigation: true },
  },
  {
