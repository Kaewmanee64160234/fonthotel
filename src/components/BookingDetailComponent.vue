        ...
        <div class="md:flex pl-8">
          ...
          formatTwoDates(
            new Date(bookingStore.currentBooking.checkOut)
                      ...
                      <br />
                      <span class="ml-9" style="display: block; text-align: left">
                        (
                        {{
            calculateNumberOfNights(
              ...
              new Date(bookingStore.currentBooking.checkOut)
                  ...
                  <div class="flex-1 flex flex-row">
                    <p class="text-sm text-base text-black">Type Room :</p>
                    <div class="flex-1 flex flex-col">
                      <div class="flex-2" style="width: 100%; font-size: 16px">
                        <ul style="font-size: 14px; padding-left: 5px">
          ...
          " class="text-sm text-base text-black p-2">No Promotion</span>
                    <span v-else class="text-sm text-base text-black p-2">
                  ...
                  <div class="flex-1 flex flex-row">
                    <p class="text-sm text-base text-black">Activity  :</p>
                    <div class="flex-1 flex flex-col">
                      <div class="flex-2" style="width: 100%; font-size: 16px">
