            ...
            <div class="card-stay">
              <div class="mt-4 pl-8">
                ...
                >
                  ...
                  <div class="facility-item text-base font-judson">
                    <p class="text-sm text-base text-black">
                      Promotion: <span v-if="props.promotion == 0">No Promotion</span>
                        <span v-else>THB {{ props.promotion.name }} Discount</span>
                    </p>
                  </div>
                  <div class="facility-item text-base font-judson">
                  ...
                  > <p class="text-sm text-base text-black">Activaty: </p>
                    ...
                    <span
                      v-if="
                        bookingStore.currentBooking.activityPerBooking.length ==
                        0
                      "
                      class="text-base font-sans"
                      style="font-size: 15px"
